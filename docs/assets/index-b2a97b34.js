...
`,N=f.div`
  ...
  gap: var(--gap-small);
`,v={WrapperXFile:N,WrapperInput:k,XFile:S,Arrow:M,ShowFiles:$,Carousel:I,Input:C,Close:j},W=({isDragLeave:e})=>e&&y`
  transform: scale(1);
`,z=({isDragEnter:e})=>e&&y`
