import{s as m,n as r,j as d}from"./styled-components.browser.esm-18f716b2.js";import"./index-8db94870.js";import"./_commonjsHelpers-042e6b4d.js";const P=m.span`
  position: relative;
  display: flex;
  gap: var(--gap-small);
  align-items: center;
...
`,T=m.label`
  ...
  ${L};
  ${Q};
`,i={XCheckbox:T,CheckboxHtml:W,Content:P},u=({name:e,children:F,value:I,checked:M=!1,onClick:p,primary:O,success:R,warning:z,error:A,disabled:B})=>d.jsxs(i.XCheckbox,{onClick:p,primary:O,success:R,warning:z,error:A,disabled:B,children:[d.jsx(i.CheckboxHtml,{name:e,value:I,checked:M}),d.jsx(i.Content,{onClick:p,children:F})]});try{u.displayName="XCheckbox",u.__docgenInfo={description:"",displayName:"XCheckbox",props:{name:{defaultValue:null,description:"",name:"name",required:!0,type:{name:"string"}},value:{defaultValue:null,description:"",name:"value",required:!0,type:{name:"string"}},checked:{defaultValue:{value:"false"},description:"",name:"checked",required:!1,type:{name:"boolean"}},onClick:{defaultValue:null,description:"",name:"onClick",required:!1,type:{name:"MouseEventHandler"}},primary:{defaultValue:null,description:"",name:"primary",required:!0,type:{name:"boolean"}},success:{defaultValue:null,description:"",name:"success",required:!0,type:{name:"boolean"}},warning:{defaultValue:null,description:"",name:"warning",required:!0,type:{name:"boolean"}},error:{defaultValue:null,description:"",name:"error",required:!0,type:{name:"boolean"}},disabled:{defaultValue:null,description:"",name:"disabled",required:!0,type:{name:"boolean"}}}}}catch{}const ee={title:"03 - Form Components/XCheckbox",component:u},a={args:{value:"dark",children:"Dark",name:"theme",checked:!1,primary:!1,success:!1,warning:!1,error:!1,disabled:!1}},s={args:{value:"dark",children:"Dark",name:"theme",checked:!0,primary:!1,success:!1,warning:!1,error:!1,disabled:!1}},n={args:{value:"dark",children:"Dark",name:"theme",checked:!0,primary:!0,success:!1,warning:!1,error:!1,disabled:!1}},l={args:{value:"dark",children:"Dark",name:"theme",checked:!0,primary:!1,success:!0,warning:!1,error:!1,disabled:!1}},c={args:{value:"dark",children:"Dark",name:"theme",checked:!0,primary:!1,success:!1,warning:!0,error:!1,disabled:!1}},o={args:{value:"dark",children:"Dark",name:"theme",checked:!0,primary:!1,success:!1,warning:!1,error:!0,disabled:!1}},t={args:{value:"dark",children:"Dark",name:"theme",checked:!0,primary:!1,success:!1,warning:!1,error:!1,disabled:!0}};var f,h,k;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    value: 'dark',
    children: 'Dark',
    name: 'theme',
...
//# sourceMappingURL=XCheckbox.stories-1ccade96.js.map
